defmodule ExAws.ElasticLoadBalancingV2.ParsersTest do
  ...
  describe "describe_listeners parser" do
    test "parses HTTPS listener DescribeListenersResponse" do
      xml = """
      ...
      expected =
        %{
          ...
          request_id: "18e470d3-f39c-11e5-a53c-67205c0d10fd"
        }
    ...
    test "parses HTTP listener DescribeListenersResponse" do
      xml = """
      <DescribeListenersResponse xmlns="http://elasticloadbalancing.amazonaws.com/doc/2015-12-01/">
        <DescribeListenersResult> 
          <Listeners> 
      ...
      {:ok, %{body: body}} = V2Parser.parse({:ok, %{body: xml}}, :describe_listeners)
